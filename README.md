...
- **Project Recreator**: Rebuilds entire project from generated structure file
- **Project Comparator**: Compares two project directories and provides detailed analysis

## Installation
```bash
pip install project-structure-utils
